/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b0643a6bde6c4d98448b7e18893ca016)
// Runtime types generated with workerd@1.20260908.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	VISITOR_COUNTER_DO: DurableObjectNamespace<import("./src/worker").VisitorCounterDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "VisitorCounterDurableObject";
	}
